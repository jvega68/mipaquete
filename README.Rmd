...
<!-- badges: start -->
[![GitHub issues](https://img.shields.io/github/issues/jvega68/mipaquete)](https://github.com/jvega68/mipaquete/issues)
[![GitHub pulls](https://img.shields.io/github/issues-pr/jvega68/mipaquete)](https://github.com/jvega68/mipaquete/pulls)
<!-- badges: end -->

The goal of `mipaquete` is to to put in one place all the functions that I use in my daily work.
...
And the development version from [GitHub](https://github.com/jvega68/mipaquete) with:
...
* The [documentation website](http://jvega68.github.io/mipaquete) is automatically updated thanks to `r BiocStyle::CRANpkg('pkgdown')`.
