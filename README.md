...
[![GitHub
issues](https://img.shields.io/github/issues/jvega68/mipaquete)](https://github.com/jvega68/mipaquete/issues)
[![GitHub
...
[GitHub](https://github.com/jvega68/mipaquete) with:

``` r
BiocManager::install("jvega68/mipaquete")
```
...
#> 
#>   Last F (2025). _mipaquete: What the Package Does (One Line, Title
#>   Case)_. R package version 0.99.0,
#>   <https://github.com/jvega68/mipaquete>.
#> 
#> A BibTeX entry for LaTeX users is
#> 
#>   @Manual{,
#>     title = {mipaquete: What the Package Does (One Line, Title Case)},
#>     author = {First Last},
#>     year = {2025},
#>     note = {R package version 0.99.0},
#>     url = {https://github.com/jvega68/mipaquete},
#>   }
```
...
- The [documentation website](http://jvega68.github.io/mipaquete) is
